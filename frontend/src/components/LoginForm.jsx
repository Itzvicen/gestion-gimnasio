...
const LoginForm = ({ onLogin }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setError(
        ...
        setShowErrorModal(true); // Muestra el modal cuando hay un error
      }
    };

    const handleCloseModal = () => {
      setShowErrorModal(false); // Oculta el modal al cerrarlo
    };
  ...
  return (
    <div>
      ...
      <div class="flex w-full login md:max-w-sm max-w-[350px] mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
        <div class="hidden bg-cover bg-[40%] lg:block lg:w-1/2 bg-[url('https://ossfitness.com/fotos/2021/07/strong-man-training-in-gym-1024x683.jpg')]"></div>
        <form onSubmit={handleSubmit} class="w-full px-6 py-8 md:px-8 lg:w-1/2">
